...
?> <?php echo $error; ?> 
  ...
  <div class= "login_screen" style="width:600px;margin:0 auto;color:rgba(24, 25, 27, 1.000);border:solid 1px grey;padding:10px;border-radius:4px;">  <?php echo 'Your Current PHP version is  : ' . phpversion(), ' <br>(PHP 5.6 or higher PHP 7+ is  advised if you are not already using these versions)'; ?>
  <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" name="pwd" > 
   Enter Your Password For WEEWX Setup Screen Below
<center>
     <input name="passwd" type="password" class="input"/>  <input type="submit" name="submit_pwd" value="Login " class="btn" /> 
         </form> 
     </center>
      <?php echo "2015-" ;?><?php echo date('Y');?> &copy;</a> WEATHER34 WEEWX DASHBOARD WE</span></span></span>
      <br><br>
 ...
 <label name="livedataFormat"></label>
  ...
  <input name="livedata" type="text" id="livedata" value="<?php echo $livedata ;?>" class="chooseapi">
	...
	<strong><svg id="i-info" viewBox="0 0 32 32" width="10" height="10" fill="rgba(67, 58, 80, 1.000)" stroke="rgba(67, 58, 80, 1.000)" stroke-linecap="round" stroke-linejoin="round" stroke-width="16.25%">
     <path d="M16 14 L16 23 M16 8 L16 10" /><circle cx="16" cy="16" r="14" /></svg></strong><span style="color:#777;"> WeeWX path example: http://yourdomain/realtime.txt</span><br>
...
*New Metar option for current ICON weather conditions + Darksky Option</strong><br>
    ...
    <path d="M30 12 L16 24 2 12" /></svg>
     ...
     <path d="M16 14 L16 23 M16 8 L16 10" /><circle cx="16" cy="16" r="14" /></svg> <span style="color:rgba(238, 98, 29, 1.000);">currentconditionsmetar34.php</span> uses Nearby Metar Aviation Weather Options must get API key and insert into option near bottom of this setup screen<BR>
     <br>
     <svg id="i-info" viewBox="0 0 32 32" width="10" height="10" fill="#01a4b4" stroke="#01a4b4" stroke-linecap="round" stroke-linejoin="round" stroke-width="16.25%">
     <path d="M16 14 L16 23 M16 8 L16 10" /><circle cx="16" cy="16" r="14" /></svg> <span style="color:rgba(238, 98, 29, 1.000);">currentconditionsds.php</span> uses DarkSky must get API key and insert into option near bottom of this setup screen<BR></strong></span></span>
...
<div class="weatheroptions">
  ...
  Set the Units you wish to display controls unit switching & set color theme</div><p>
...
<br><br>
       ...
       <svg id="i-chevron-right" viewBox="0 0 32 32" width="14" height="14" fill="none" stroke="rgba(238, 98, 29, 1.000)" stroke-linecap="round" stroke-linejoin="round" stroke-width="6.25%">
    <path d="M12 30 L24 16 12 2" />
</svg><svg id="i-chevron-bottom" viewBox="0 0 32 32" width="10" height="10" fill="#777" stroke="#777" stroke-linecap="round" stroke-linejoin="round" stroke-width="6.25%">
    <path d="M30 12 L16 24 2 12" />
</svg>
       <label name="uvhardware"></label>
        <select id="uvhardware" name="uvhardware" class="choose">  
            ...
            <option>cloudbase.php</option>
            <option>cloudbasesolaruk.php</option>
            <option>cloudbasesolards.php</option>      
...
<strong><svg id="i-info" viewBox="0 0 32 32" width="10" height="10" fill="#F75C46" stroke="#F75C46" stroke-linecap="round" stroke-linejoin="round" stroke-width="16.25%">
     ...
     <strong><svg id="i-info" viewBox="0 0 32 32" width="10" height="10" fill="#F75C46" stroke="#F75C46" stroke-linecap="round" stroke-linejoin="round" stroke-width="16.25%">
     <path d="M16 14 L16 23 M16 8 L16 10" /><circle cx="16" cy="16" r="14" /></svg><span style="color:#777"> New option <span style="color:rgba(67, 58, 80, 1.000)">cloudbase.php</span> if you want <strong><span style="color:#777"> to use combined solar data and cloudbase </strong> <span style="color:#777;"> information  *note you must have solar radiation and UV sensors!!!<br><br></span></span>


  <strong><svg id="i-info" viewBox="0 0 32 32" width="10" height="10" fill="#F75C46" stroke="#F75C46" stroke-linecap="round" stroke-linejoin="round" stroke-width="16.25%">
     <path d="M16 14 L16 23 M16 8 L16 10" /><circle cx="16" cy="16" r="14" /></svg><span style="color:#777"> New option <span style="color:rgba(67, 58, 80, 1.000)">cloudbasesolards.php</span> if you want <strong><span style="color:#77"> use to combined solar data Dark Sky UV forecast </strong> <span style="color:#777;"> information  *note you must have solar radiation sensor!!!<br><br></span></span>
     
     <strong><svg id="i-info" viewBox="0 0 32 32" width="10" height="10" fill="#F75C46" stroke="#F75C46" stroke-linecap="round" stroke-linejoin="round" stroke-width="16.25%">
     <path d="M16 14 L16 23 M16 8 L16 10" /><circle cx="16" cy="16" r="14" /></svg> <span style="color:rgba(67, 58, 80, 1.000)"> Beta..1st May 2018 New option <span style="color:rgba(67, 58, 80, 1.000)">cloudbasesolaruk.php</span> <span style="color:#777">if you want <strong><span style="color:#777"> to measure UVINDEX from your solar radiation UK users only</strong> <span style="color:#777;"> information  *note you must have solar radiation sensor!!!...this option was tested by uK users who did not have hardware to measure..75-90% accurate its realtime.. <br><br></span></span>
 ...
 <br>
  <strong><svg id="i-info" viewBox="0 0 32 32" width="10" height="10" fill="#F75C46" stroke="#F75C46" stroke-linecap="round" stroke-linejoin="round" stroke-width="16.25%">
     <path d="M16 14 L16 23 M16 8 L16 10" /><circle cx="16" cy="16" r="14" /></svg><span style="color:#777"> New option <span style="color:rgba(67, 58, 80, 1.000)">indoortemperature.php </span>Indoor Temperature <strong><span style="color:#777">  <br><br></span></span>
...
<path style="fill:rgba(238, 98, 29, 1.000);stroke:#ccc;stroke-width:0.0938;" d="M536.9,99.9c6.8,5.2,12.7,11.6,19.2,17.2
...
<br> <svg id="i-info" viewBox="0 0 32 32" width="12" height="12" fill="none" stroke="#777" stroke-linecap="round" stroke-linejoin="round" stroke-width="2">
 ...
 <center> <span style="color:rgba(238, 98, 29, 1.000);">*IMPORTANT</span> NEW DARKSKY API (uses old script originally used in  2016) requires personal API KEY(MAY 30TH 2018) available via 
...
<br>
   <p>      
    ...
    <path d="M16 14 L16 23 M16 8 L16 10" />
    <circle cx="16" cy="16" r="14" />
</svg> <span style="color:#777;">enter your <strong>PurpleAir </strong> station id example <strong><span style="color:rgba(238, 98, 29, 1.000);"> 1200</strong></span></span>
...
<div class= "stationvalue">Do you have Weatherflow Station</div> <svg id="i-chevron-right" viewBox="0 0 32 32" width="14" height="14" fill="none" stroke="rgba(238, 98, 29, 1.000)" stroke-linecap="round" stroke-linejoin="round" stroke-width="6.25%">
    <path d="M12 30 L24 16 12 2" />
</svg><svg id="i-chevron-bottom" viewBox="0 0 32 32" width="10" height="10" fill="#777" stroke="#777" stroke-linecap="round" stroke-linejoin="round" stroke-width="6.25%">
    <path d="M30 12 L16 24 2 12" />
</svg>
   ...
   <label name="weatherflowoption"></label>
        <select id="weatherflowoption" name="weatherflowoption" class="choose1" >
            ...
            <br>
        <strong> Select <span style="color:rgba(24, 25, 27, 0.8);">Yes</span> or <span style="color:rgba(238, 98, 29, 1.000);">No</span></strong><br>
...
<div class="weatheroptions">
  ...
  <svg id="i-alert" viewBox="0 0 32 32" width="14" height="14" fill="none" stroke="rgba(238, 98, 29, 1.000)" stroke-linecap="round" stroke-linejoin="round" stroke-width="6.25%">
   ...
   <p>
   <div class="weatheroptionssidebarbottom"><svg id="i-alert" viewBox="0 0 32 32" width="14" height="14" fill="none" stroke="rgba(238, 98, 29, 1.000)" stroke-linecap="round" stroke-linejoin="round" stroke-width="6.25%">
...
<div class="weatherbottominfo">
<svg id="i-info" viewBox="0 0 32 32" width="14" height="14" fill="none" stroke="rgba(238, 98, 29, 1.000)" stroke-linecap="round" stroke-linejoin="round" stroke-width="6.25%">
    <path d="M16 14 L16 23 M16 8 L16 10" />
    <circle cx="16" cy="16" r="14" />
</svg>
...
<svg id="i-checkmark" viewBox="0 0 32 32" width="12" height="12" fill="none" stroke="currentcolor" stroke-linecap="round" stroke-linejoin="round" stroke-width="6.25%">
    ...
    <path d="M16 14 L16 23 M16 8 L16 10" />
    <circle cx="16" cy="16" r="14" />
</svg> WEEWX DASHBOARD EASY SETUP &copy; 2015-<?php echo date('Y');?> Dashboard <span style="color:rgba(67, 58, 80, 1.000);">WE</span>-<span style="color:rgba(238, 98, 29, 1.000);">AUG 30th 2018</span></span>
