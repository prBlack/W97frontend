<?php include('livedata.php');include('common.php');header('Content-type: text/html; charset=utf-8');$software    = 'Cumulus <span>Software</span>';$designedfor    = '<br>For Cumulus';?>
