...
border:0;color:#aaa;overflow:hidden!important;margin-bottom:5px;border:solid 1px #444;border-bottom:solid 1px #444;border-top:1px solid rgba(255, 124, 57, 1.000);}
.darkskyweekdayhome{postion:absolutue;text-align:center;padding:0;color:#fff;font-family:Arial;font-size:11px;margin:0;background:0;margin-bottom:12px;}
		...
		<div style="position:absolute;width:725px;background:none;margin:0 auto;margin-left:7%;margin-top:25px;">
			<div class="titleforecast"><span style="color:#aaa;font-size:12px;  font-family: arial, sans-serif;"><?php
echo "${stationName} \n";
?><green>Hourly</green><orange> Forecast</orange> </div>
        <br>
      ...
      foreach ($darkskyhourlyCond as $cond) {     
			...
			$darkskyhourlyWindGust = round($cond['windGust'],0);
			  if ($hi++ == 10) break; 
				  ...
				  if ($darkskyhourlyprecipIntensity>0){echo '<darkskyiconcurrent><img src="css/darkskyicons/rain.svg" width="50" ></img></darkskyiconcurrent>';}
				  else if ($darkskyhourlyPrecipProb>=10 && date("G", $darkskyhourlyTime) >$suns2){echo '<darkskyiconcurrent><img src="css/darkskyicons/nt_chancerain.svg" width="50"></img></darkskyiconcurrent>';}
			      else if ($darkskyhourlyPrecipProb>=10 && date("G", $darkskyhourlyTime) <$sunr2){echo '<darkskyiconcurrent><img src="css/darkskyicons/nt_chancerain.svg" width="50"></img></darkskyiconcurrent>';}	
				  else if ($darkskyhourlyPrecipProb>=10){echo '<darkskyiconcurrent><img src="css/darkskyicons/chancerain.svg" width="50" ></img></darkskyiconcurrent>';}			  
				  else if (date("G", $darkskyhourlyTime) >$suns2){echo '<darkskyiconcurrent><img src="css/darkskyicons/nt_'. $darkskyhourlyIcon.'.svg" width="50"></img></darkskyiconcurrent>';}
 ...
 <div style="position:absolute;bottom:5px;z-index:9999;font-weight:normal;font-size:10px;color:#aaa;text-decoration:none !important;float:right;font-family:arial;">
   ...
   &nbsp;&nbsp;data provided by <a href="https://darksky.net/about" title="https://darksky.net" target="_blank">https://darksky.net/</a> -- PHP scripts by <a href="https://weather34.com" title="weather34.com" target="_blank">weather34.com</a>  &copy;<?php echo date('Y');?>
  </div>
  </body>
  </html>