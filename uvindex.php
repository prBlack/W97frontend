...
<path fill="<?php if ($weather["uv"]>0){echo 'rgba(146, 177, 42, 0.8)';} else echo 'currentcolor';?>" d=" M 37.24 719.17 C 147.49 718.78 257.75 719.11 368.00 719.00 C 559.56 719.13 751.13 718.75 942.69 719.19 C 954.83 742.74 967.22 766.17 980.00 789.39 L 980.00 792.00 L 0.00 792.00 L 0.00 789.37 C 12.76 766.16 25.41 742.86 37.24 719.17 Z" />
 ...
 if ($weather["uv"]>=10){echo  "<uv10>",number_format($weather["uv"] ,1),"</<uv10>";}
	...
	else if ($weather["uv"]>=0){echo  "<uv0>",$weather["uv"], "</uv0>";}
?>
 </span>
