...
.weather34icloudair1{color:rgba(255, 124, 57, 1.000);position:absolute;margin-left:165px;margin-top:70px;font-family:-apple-system, BlinkMacSystemFont, "weathertext", Roboto, Helvetica, Arial, sans-serif;max-height:42px;font-weight:normal;background:#2a2e33;width:41px;height:42px;-webkit-border-radius:100%;-moz-border-radius:100%;-o-border-radius:100%;-ms-border-radius:100%;border-radius:100%;font-size:14px;line-height:10px;padding-top:10px;border:.12rem solid rgba(95,96,97,.9);padding-left:3px;}
.weather34icloudair1 span{font-family:-apple-system, BlinkMacSystemFont, "weathertext", Roboto, Helvetica, Arial, sans-serif;font-size:0.7em;font-weight:normal;margin-left:5px;color:#aaa;}
...
<body>
  <section class="weather34title">
   <p><?php echo $info ;?> Cloudbase & Purple Air Quality Data <?php echo $stationlocation;?></p>
</section>
...
<?php  
 ...
 <div class="lotemp">
<?php //cloudbase
	echo $weather["cloudbase3"], "<orange> ft</orange><br>"; echo round($weather["cloudbase3"]*0.3048,0), "<orange> mt</orange>";?>
...
<actual><?php echo date('jS D H:i');?></actual>
</div></div></div></div>
...
<div class="provided">   
&nbsp;
Air Quality data provided by <a href="https://purpleair.com/" title="https://purpleair.com/" target="_blank">https://purpleair.com</a> --PHP scripts by <a href="https://weather34.com" title="weather34.com" target="_blank">weather34.com  &copy;<?php echo date('Y');?></a></div>
</body>
</html>