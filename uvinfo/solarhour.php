...
foreach ($decoded['hourly_forecast'] as $value)
{
	...
	$hour = $value['FCTTIME']['hour_padded']; //changed ['hour']
...
?>
 ...
 font-family:'weathertext',Helvetica,Arial,sans-serif;">8-10</span></span>
  ...
  <div style="position:absolute;margin-left:15%;bottom:-45px;z-index:9999;font-weight:normal;font-size:12px;text-decoration:none !important;padding:5px;background:#505153;border-radius:4px;color:#ccc;">
  ...
  PHP scripts by <a href="https://weather34.com" title="weather34.com" target="_blank">weather34.com</a>  &copy;<?php echo date('Y');?></div></div>
