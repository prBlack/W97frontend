<?php
include_once('../settings.php');header('Content-type: text/html; charset=utf-8');
	...
	# 	                                                                                               #
	# 	                                                                                               #
	# 	ALL4ONE (CANVAS) UVINDEX FORECAST: 7TH October 2016     	    	                           #
	# 	 Original Script by Ken True - saratoga-weather.org                                            #
...
// by the webserver.
$UVcacheName = $cacheFileDir."../jsondata/uv-forecast.txt";
