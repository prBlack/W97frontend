<?php include_once('../settings.php');include('../common.php');?>
...
<?php $hourly=file_get_contents('../jsondata/wuweatherupdate.txt');$decoded=json_decode($hourly,true);$count=0;foreach($decoded['hourly_forecast'] as $value){$count++;$hour=$value['FCTTIME']['hour'];$uvi=$value['uvi'];echo "<div class=\"uvi01\"><span>${hour}:00</span><br>$uvi<p>UVINDEX</div>";if($count>13)break;}?>
</div>
...
<span style="font-size:20px;font-weight:normal;color:rgba(255,255,255,1);position:absolute;text-align:center;padding-top:0;background:0;top:27.5%;left:0;bottom:0;right:0;font-family:'weathertext',Helvetica,Arial,sans-serif">1-2</span></span>
</div>
<div class="mdl-card__supporting-text">
<?php echo $lang['Nocaution'];?>
</div>
...
<span style="font-size:20px;font-weight:normal;color:rgba(255,255,255,1);position:absolute;text-align:center;padding-top:0;background:0;top:27.5%;left:0;bottom:0;right:0;font-family:'weathertext',Helvetica,Arial,sans-serif">3-5</span></span>
</div>
<div class="mdl-card__supporting-text">
...
<span style="font-size:20px;font-weight:normal;color:rgba(255,255,255,1);position:absolute;text-align:center;padding-top:0;background:0;top:27.5%;left:0;bottom:0;right:0;font-family:'weathertext',Helvetica,Arial,sans-serif">6-7</span></span>
</div>
<div class="mdl-card__supporting-text">
...
<span style="font-size:20px;font-weight:normal;color:rgba(255,255,255,1);position:absolute;text-align:center;padding-top:0;background:0;top:27.5%;left:0;bottom:0;right:0;font-family:'weathertext',Helvetica,Arial,sans-serif">8-10</span></span>
</div>
<div class="mdl-card__supporting-text">
...
<span style="font-size:20px;font-weight:normal;color:rgba(255,255,255,1);position:absolute;text-align:center;padding-top:0;background:0;top:27.5%;left:0;bottom:0;right:0;font-family:'weathertext',Helvetica,Arial,sans-serif">11+</span></span>
</div>
<div class="mdl-card__supporting-text">
<?php echo $lang['Reducetime'];?>
</div>
...
<style>a{font-size:10px;color:#ccc;text-decoration:none!important}</style>
...
<div class= "credit" style="margin-left:600px;"> PHP scripts by <a href="https://weather34.com" title="weather34.com" target="_blank">weather34.com</a>  &copy;<?php echo date('Y');?></div>
</body>
</html><!--20-March-2017 HOMEWEATHERSTATION -->