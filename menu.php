<?php include('https://claydonsweather.org.uk/version.php');?>
<header><!---start menu.php 23-02-2018--><h1><ogreyh1><?php echo $stationName;?>&nbsp; Home &#8226; Weather &#8226; Station </ogreyh1></h1>
...
<div class="w34uptime"><?php echo $info." Uptime: "?><?php echo "$uptimedays";?></div>
...
<li><a href="easyweathersetup.php" target="_blank" title="СТРАНИЦА НАСТРОЕК"><?php echo $weather34settingsicon; echo " ",$lang['Settings']; ?> </a></li> 
<p>
<li><a href="#">Пользовательские настройки</a></li>
<li><a href="index.php" title="ДОМАШНЯЯ СТРАНИЦА"> <?php echo $weather34homeicon; echo ' Home'; ?> </a></li>  
<li><a href=<?php if($theme=='dark'){echo'?theme=light';}else{echo'?theme=dark';}?>><?php echo $arrow34icon;?><?php if($theme=='dark'){echo' СВЕТЛЫЙ ФОН';}else{echo' ТЕМНЫЙ ФОН';}?></a></li>
<p>
...
<li>
<?php if($weatherflowoption=="yes"){ echo "<a href=https://staging.smartweather.weatherflow.com/map/".$lat."/".$lon."/".$weatherflowmapzoom." data-featherlight=iframe>". $locationinfo." КАРТА МЕТЕОСТАНЦИЙ </a></li>" ;}
else echo "";?>
<li><!---webcam---> <a href="cam.php" data-featherlight="iframe" title="WEATHERSTATION WEBCAM"> <?php echo $webcam34icon;?> КАМЕРА </a></li>  
<li><!--info---> <a href="bio.php" data-featherlight="iframe" title="Contact WEATHERSTATION Info"> <?php echo $info;?> КОНТАКТЫ</a></li>  
...
<!---languages---> 
  ...
  <a href="index.php?lang=ru"><img src="img/flags/ru.svg"  title="Русский" width="25px" height="25px"></a>&nbsp;
...
<script>(function() {	var date = new Date(),	weekday = ["Sunday", "Monday", "Tue", "Wed", "Thur", "Friday", "Sat"];	document.getElementById('weather34weekday').innerHTML = weekday[date.getDay()];	document.getElementById('weather34day').innerHTML = date.getDate();}) ();</script>
