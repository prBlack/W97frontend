...
//1st september 2018 extra weather34 lets manipulate the output according to arc radius
...
$ago = $suns - $now;
$gain = date('i')/10;
//weather34 rotate the sun
//morning sunrise to 12
if (date('G')==1){echo -45+date('G');}
else if (date('G')==2){echo -60+date('G.i')+$ago ;}
else if (date('G')==3){echo -60+date('G.i')+$ago ;}
else if (date('G')==4){echo -60+date('G.i')+$ago ;}
else if (date('G')==5){echo -60+date('G.i')+$ago ;}
else if (date('G')==6){echo -60+date('G.i')+$ago+$gain ;}
else if (date('G')==7){echo -55+date('G.i')+$ago+$gain ;}
else if (date('G')==8){echo -45+date('G.i')+$ago+$gain ;}
else if (date('G')==9){echo -35+date('G.i')+$ago+$gain ;}
else if (date('G')==10){echo -25+date('G.i')+$ago+$gain ;}
else if (date('G')==11){echo -10+date('G.i')+$ago+$gain ;}
else if (date('G')==12){echo date('G.i')*2.8+$ago+$gain ;}
//afternoon 12-sunset
else if (date('G')==13){echo date('G.i')*3.75+$ago ;}
else if (date('G')==14){echo date('G.i')*4+$ago;}
else if (date('G')==15){echo date('G.i')*5.10+$ago;}
else if (date('G')==16){echo date('G.i')*5.5+$ago;}
else if (date('G')==17){echo date('G.i')*5.5+$ago;}
else if (date('G')==18){echo date('G.i')*6+$ago;}
else if (date('G')==19){echo date('G.i')*6+$ago;}
else if (date('G')==20){echo date('G.i')*6+$ago;}
else if (date('G')==21){echo date('G.i')*6+$ago;}
else if (date('G')==22){echo date('G.i')*6+$ago;}
else if (date('G')==23){echo date('G.i')*6+$ago;}
else if (date('G')==24){echo date('G.i')*6+$ago;}
else echo '';
?>
deg);
...
.thearrow5:before{color:<?php if (date('H:i')<$suns1){echo '#ff8841';}else '#aaa' ?>;display:

<?php 
if (date('H:i')>$suns){echo 'none';}
if (date('H:i')<$sunr){echo 'none';}
else 'inline' ?>;}
