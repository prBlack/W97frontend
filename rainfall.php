<?php include_once('livedata.php');?><div class="updatedtime"><span><?php if(file_exists($livedata)&&time()- filemtime($livedata)>300)echo $offline. '<offline> Offline </offline>';else echo $online; echo " ",$weather["time"];?></div>
...
<div class="weather34i-rairate-bar">
 ...
 <div class="weather34todayraintext"><?php 
 if ($weather["rain_today"] >=100){echo  "<oblue>",number_format($weather["rain_today"]  ,0), "<br><span>".$weather["rain_units"]."</span></oblue>";}
 else if ($weather["rain_today"] >=0){echo  "<oblue>",$weather["rain_today"], "<br><span>".$weather["rain_units"]."</span></oblue>";}?>
 </span></div>  
...
<path fill="<?php if($weather["rain_rate"]>0){echo " #00a4b4";} else if ($weather["rain_units"] =='in' && $weather["rain_rate"]>0){echo " #00a4b4";}else echo "currentcolor"?>"  opacity="1.00" d=" M 7.00 72.00 C 17.00 72.00 27.00 72.00 37.00 72.00 C 37.00 73.67 37.00 75.33 37.00 77.00 C 27.00 77.00 17.00 77.00 7.00 77.00 C 7.00 75.33 7.00 73.67 7.00 72.00 Z" /></svg>
 ...
 <?php
//metric to f + humidex
echo "<div class=maxcirclerain><div class=rainratesmall>Rate</div>".number_format($weather["rain_rate"],2);?> 