...
if ($pressureunit != $weather["barometer_units"]) {
	...
	else if ($pressureunit == "mmHg" && ($weather["barometer_units"] == 'mb' || $weather["barometer_units"] == 'hPa')) {
		mbTommH($weather, "barometer");
		mbTommH($weather, "barometer_trend");
		mbTommH($weather, "barometermovement");
		mbTommH($weather, "barometer_max");
		mbTommH($weather, "barometer_min");
		$weather["barometer_units"] = $pressureunit;
	}
	else if ($pressureunit == "mmHg" && $weather["barometer_units"] == 'inHg') {
		inTommH($weather, "barometer");
		inTommH($weather, "barometer_trend");
		inTommH($weather, "barometermovement");
		inTommH($weather, "barometer_max");
		inTommH($weather, "barometer_min");
		$weather["barometer_units"] = $pressureunit;
	}
...
$meteor_events[]=array("event_start"=>mktime(0, 0, 0, 4, 9),"event_title"=>"Лириды","event_end"=>mktime(23, 59, 59, 4, 20),);
$meteor_events[]=array("event_start"=>mktime(0, 0, 0, 4, 21),"event_title"=>"Лириды (пик)","event_end"=>mktime(23, 59, 59, 4, 22),);
...
$meteor_events[]=array("event_start"=>mktime(0, 0, 0, 8, 1),"event_title"=>"Персеиды","event_end"=>mktime(23, 59, 59, 8, 10),);
$meteor_events[]=array("event_start"=>mktime(0, 0, 0, 8, 11),"event_title"=>"Персеиды (пик)","event_end"=>mktime(23, 59, 59, 8, 13),);
$meteor_events[]=array("event_start"=>mktime(0, 0, 0, 8, 14),"event_title"=>"Персеиды прошли","event_end"=>mktime(23, 59, 59, 8, 18),);
$meteor_events[]=array("event_start"=>mktime(0, 0, 0, 10, 6),"event_title"=>"Дракониды","event_end"=>mktime(23, 59, 59, 10, 7),);
...
$meteor_events[]=array("event_start"=>mktime(0, 0, 0, 11, 13),"event_title"=>"Леониды ","event_end"=>mktime(23, 59, 59, 11, 16),);
$meteor_events[]=array("event_start"=>mktime(0, 0, 0, 11, 17),"event_title"=>"Леониды (пик)","event_end"=>mktime(23, 59, 59, 11, 18),);
$meteor_events[]=array("event_start"=>mktime(0, 0, 0, 11, 19),"event_title"=>"Леониды ","event_end"=>mktime(23, 59, 59, 11, 29),);
$meteor_events[]=array("event_start"=>mktime(0, 0, 0, 11, 30),"event_title"=>"Гемениды ","event_end"=>mktime(23, 59, 59, 12, 12),);
$meteor_events[]=array("event_start"=>mktime(0, 0, 0, 12, 13),"event_title"=>"Гемениды (пик)","event_end"=>mktime(23, 59, 59, 12, 14),);
$meteor_events[]=array("event_start"=>mktime(0, 0, 0, 12, 17),"event_title"=>"Урсиды ","event_end"=>mktime(23, 59, 59, 12, 20),);
$meteor_events[]=array("event_start"=>mktime(0, 0, 0, 12, 21),"event_title"=>"Урсиды (пик)","event_end"=>mktime(23, 59, 59, 12, 22),);
$meteor_events[]=array("event_start"=>mktime(0, 0, 0, 12, 23),"event_title"=>"Урсиды ","event_end"=>mktime(23, 59, 59, 12, 25),);
$meteorNow=time();
$meteorOP=false;
