...
<div class="weather34-uvrate-bar">
    <div class="bar bar-1" style="height:100px;max-height:100px;">
    <?php	
	//weather34 wu uv index forecast
...
{$count++;  
	...
	if ($uvi>10){echo '<div class="bar bar-inner10" style="height: ';}	
	else if ($uvi>8){echo '<div class="bar bar-inner8" style="height: ';}	
	else if ($uvi>5){echo '<div class="bar bar-inner5" style="height: ';}	
	else if ($uvi>3){echo '<div class="bar bar-inner3" style="height: ';}	
	else if ($uvi>=0){echo '<div class="bar bar-inner" style="height: ';}	
	echo $uvi*8+1;?>px;">
    </div></div>    
  </div>
 <div class="weather34uvrate"><span><?php 
 if ($uvi>10){echo  "<purpleuv>",number_format($uvi,1), "</purpleuv><solarwm2> UVI</solarwm2>";}
	else if ($uvi>8){echo  "<reduv>",number_format($uvi,1), "</reduv><solarwm2> UVI</solarwm2>";}
	else if ($uvi>5){echo  "<orangeuv>",number_format($uvi,1), "</orangeuv><solarwm2> UVI</solarwm2>";}
	else if ($uvi>3){echo  "<orangeuv>",number_format($uvi,1), "</orangeuv><solarwm2> UVI</solarwm2>";}
	else if ($uvi>=0.1){echo  "<greenuv>",number_format($uvi,1), "</greenuv><solarwm2> UVI</solarwm2>";}
	else if ($uvi>=0){echo  "<greyuv>",number_format($uvi ,1), "</greyuv><solarwm2> UVI</solarwm2>";}
