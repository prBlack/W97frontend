...
<html>
	...
	function processData2(allText) {
		...
		title: {
            text: " <?php echo $stationlocation ;?> <?php echo $lang['Temperature'] ;?> (<?php echo $tempunit ;?>) - <?php echo $lang['Humidity'] ;?> (<?php echo "%" ;?>) <?php echo $lang['Today'];?>",
			fontSize: 11,
			fontColor:' #ccc',
			fontFamily: "arial",
        },
...
<div id="chartContainer" style="height: 375px; width:99%;margin-left:0px;border:3px solid rgba(153,153,153,1);border-radius:4px;font-size: 12px;color:#fff;"></div></div>
