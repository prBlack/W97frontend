...
echo "${stationName} \n";
?><span style="color:#ff8841">Forecast </span><green>Summary</green></span></span> </div>
        <br>
        ...
        foreach ($darkskydayCond as $cond) {
			...
			$darkskydayWindGust = round($cond['windGust'],0);
				  ...
				  if ($darkskydayPrecipProb>20){echo '<img src="css/darkskyicons/chancerain.svg" width="50"></img><br>';} 
				 ...
				 if ($darkskydayWinddir <15 ) echo $lang['North'];
				  ...
				  if ($darkskydayPrecipType='Rain'){
				  echo ''.$rainsvg.'&nbsp;<darkskytempwindhome><span>'.$darkskydayPrecipType.'<blue1>&nbsp;'. $darkskydayprecipIntensity.'</blue1>'.$rainunit.'&nbsp;<blue1>'.$darkskydayPrecipProb.'</blue1>%</darkskywindhome></span>';}  
				  else if ($darkskydayPrecipType='Snow'){
				  echo '<darkskytempwindhome><span>Chance of '.$darkskydayPrecipType.'<blue1>&nbsp;'.$snowflakesvg.'&nbsp;'.$darkskydayPrecipProb.'</blue1>%</darkskywindhome></span>';}  
 ...
 <div style="position:absolute;bottom:5px;z-index:9999;font-weight:normal;font-size:10px;color:#aaa;text-decoration:none !important;float:right;font-family:arial;">
   ...
   &nbsp;&nbsp;data provided by <a href="https://darksky.net/about" title="https://darksky.net/about" target="_blank">DarkSky</a> -- PHP scripts by <a href="https://weather34.com" title="weather34.com" target="_blank">weather34.com</a>  &copy;<?php echo date('Y');?>
  </div>
  </body>
  </html>