...
<?php
//metric to f + humidex
if( $weather["humidex"]>30){echo "<div class=maxcirclered><div class=small>Humidex<br></div>".$weather["humidex"]."&deg;" ;}
else if( $weather["humidex"]>29){echo "<div class=maxcircleorange><div class=small>Humidex<br></div>".$weather["humidex"]."&deg;" ;}  
else if( $weather["humidex"]>18){echo "<div class=maxcircleyellow><div class=small>Humidex<br></div>".$weather["humidex"]."&deg;" ;}
else if( $weather["humidex"]>10){echo "<div class=maxcirclegreen><div class=small>Humidex<br></div>".$weather["humidex"]."&deg;" ;}
else if( $weather["humidex"]>0){echo "<div class=maxcircleblue><div class=small>Humidex<br></div>".$weather["humidex"]."&deg;" ;}
?>
</div></div></div>
