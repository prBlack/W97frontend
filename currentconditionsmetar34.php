...
//lightning
if ($weather["lightningtimeago"]>0 && $weather["lightningtimeago"]<600 && $weather["rain_rate"]>0){echo "<img rel='prefetch' src='css/icons/tstorm.svg' width='75px' alt='weather34 rain lightning icon'>";}
else if ($weather["lightningtimeago"]>0 && $weather["lightningtimeago"]<600 ){echo "<img rel='prefetch' src='css/icons/lightning.svg' width='75px' alt='weather34 rain lightning icon'>";}
...
//windy moderate
else if($weather["wind_speed_avg"]>20 && $now >$suns2){echo "<img rel='prefetch' src='css/icons/nt_windy.svg' width='75px' alt='weather34 windy icon'>";}
else if($weather["wind_speed_avg"]>20 && $now <$sunr2){echo "<img rel='prefetch' src='css/icons/nt_windy.svg' width='75px' alt='weather34 windy icon'>";}
else if($weather["wind_speed_avg"]>20){echo "<img rel='prefetch' src='css/icons/windy.svg' width='75px' alt='weather34 windy icon'>";}


//windy very
else if($weather["wind_speed_avg"]>30 && $now >$suns2){echo "<img rel='prefetch' src='css/icons/nt_windy.svg' width='75px' alt='weather34 windy icon'>";}
else if($weather["wind_speed_avg"]>30 && $now <$sunr2){echo "<img rel='prefetch' src='css/icons/nt_windy.svg' width='75px' alt='weather34 windy icon'>";}
else if($weather["wind_speed_avg"]>30){echo "<img rel='prefetch' src='css/icons/windy.svg' width='75px' alt='weather34 windy icon'>";}
...
?>
</div><div class="darkskysummary"><span>
<?php 
