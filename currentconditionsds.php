...
//rain
else if ($result <20 && $weather["rain_rate"]>0) {echo "<img rel='prefetch' src='css/icons/tstorm.svg' width='75px' alt='weather34 lightning icon'>";}
else if ($result <20){echo "<img rel='prefetch' src='css/icons/lightning.svg' width='75px' alt='weather34 lightning icon'>";}
...
//rain-weather34
 ...
 <img rel='prefetch' src='css/darkskyicons/nt_".$darkskycurIcon.".svg' width='75px' alt='weather34 icon'>";}
else if($now <$sunr2){echo "
 <img rel='prefetch' src='css/darkskyicons/nt_".$darkskycurIcon.".svg' width='75px' alt='weather34icon'>";}
else echo "
 <img rel='prefetch' src='css/darkskyicons/".$darkskycurIcon.".svg' width='75px' alt='weather34 icon'>";?> 
...
//darksky conditions
else echo '<uppercase>',$darkskycurSummary.' '.$lang['Conditions'].'</uppercase> '; ?>
</span></div>
