...
<html>
	<head>
		...
		<title>MONTHLY TEMPERATURE DATABASE CHARTS</title>	
	...
	$.ajax({
		...
		title: {
            text: "<?php echo $stationName;?> <?php echo $lang['Temperature'] ;?> (<?php echo $tempunit ;?>) <?php echo strftime(" %B") ;?> <?php echo date(" Y") ;?>",
			fontSize: 12,
			fontColor:' #ccc',
			fontFamily: "arial",
        },
