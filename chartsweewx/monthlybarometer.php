<?php
	...
	include('../settings.php');	include('conversion.php');include('/var/www/html/common.php');include('../settings1.php');
    echo '
...
<script src=js/jquery.js></script>
	...
	function processData1(allText) {
		...
		title: {
            text: "<?php echo $stationName;?> <?php echo $lang['Barometer'] ;?> (<?php echo $pressureunit ;?>) <?php echo strftime(" %B") ;?> <?php echo date(" Y") ;?>",
			fontSize: 12,
			fontColor:' #ccc',
			fontFamily: "arial",
        },
